...
const ServiceSlider2 = () => {
  ...
  useEffect(() => {
    fetch(
      "https://devhiveserver.vercel.app/service/category/6438a5eb2118772c696bccd3"
    )
      .then((res) => res.json())
  ...
  return (
    <div className="w-11/12 mt-8 h-full mx-auto">
      <div className="flex justify-between flex-col md:flex-row items-center">
        <h2 className="text-3xl text-primary w-full  font-bold">
          Trending right now
        </h2>
        <div className="flex md:justify-end w-full justify-between">
